...
def main():
	...
	experiment_dict['exp_path'] = "/mnt/fs0/arc11_2/solution_data/" + experiment_dict["exp_id"]
	...
	for j in range(num_updates):
		...
		for step in range(experiment_dict['num_steps']):
			...
			# print(new_action)
			obs, reward, done, infos, inputs, prestate = env.step(action/8.0, terminate_unreachable=experiment_dict['terminate_unreachable'], \
