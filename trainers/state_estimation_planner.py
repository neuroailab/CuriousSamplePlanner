...
from trainers.architectures import ConvWorldModel
...
class StateEstimationPlanner(ACPlanner):
    def __init__(self, *args):
        ...
        self.worldModel = opt_cuda(ConvWorldModel(config_size=self.environment.config_size,
                                                  num_perspectives=len(self.environment.perspectives)))
